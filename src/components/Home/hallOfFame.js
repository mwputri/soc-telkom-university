                  ...
                  <div className="w-75">
                    ...
                    <figure
                      ...
                      <figcaption
                        ...
                        <p>Travel CRS (Pikniklah.com): Pembangkit Jadwal Kunjungan Wisata Otomatis</p>
                      </figcaption>
                    </figure>
                    <a href="#"
                ...
                <div className="py-4 px-3 flex flex-col items-center">
                  <div className="w-75">
                    ...
                    <figure
                      ...
                      <figcaption
                        className="absolute px-4 pb-2 text-lg text-white bottom-0 text-left bg-black bg-opacity-50">
                        <p>Implementasi Pengamanan Ruang Penyimpan Bibit Vaksin Berbasis Internet of Things (IoT) Menggunakan Platform OpenMTC
                        </p>
                      </figcaption>
                    </figure>
                    <a href="#"
