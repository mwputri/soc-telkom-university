            ...
            <figcaption className="absolute text-black top-0 w-full h-full figCaptionContainer">
                ...
                <div className="flex w-full justify-evenly imgContainer">
                    <a href="#" className="flex flex-col items-center justify-center">
                        ...
                        <p className="text-xs text-black"><span
                            className="text-xs lg:text-2xl font-bold mt-2">IJoICT</span> <br/>
                            <span
                                className="desc">(International Journal  on Information and Communication Technology)</span>
                        </p>
                    </a>
                    <a href="#" className="flex flex-col items-center justify-center">
                        <img className="imgSoc" src={prestasi2} alt=""/>
                        <p className="text-xs text-black"><span
                            className="text-xs lg:text-2xl font-bold mt-2">IndoJC</span> <br/>
